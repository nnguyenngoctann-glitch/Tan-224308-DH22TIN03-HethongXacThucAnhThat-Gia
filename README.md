...
- SQLite: lưu lịch sử dự đoán (thời gian, file, kết quả, độ tin cậy, ảnh gốc).
...
artifacts/
  history.db         # Database lưu lịch sử dự đoán
...
- backend/api.py:
  ...
  - Endpoint GET /history trả danh sách lịch sử dự đoán.
  - Endpoint GET /history/{id} trả chi tiết kèm ảnh gốc (base64).
...
| ResNet18 | 0.8955 | 0.8955 | 0.8955 | 0.8955 | 0.9613 | 4.39 | 6.50 | 191.43 | RAM 922.68 MB / VRAM 409.51 MB |
| ResNet50 | 0.9216 | 0.9223 | 0.9216 | 0.9216 | 0.9759 | 8.25 | 13.47 | 109.38 | RAM 928.04 MB / VRAM 710.08 MB |
